...
基于 Cloudflare Workers 的「挪车提醒」服务：访客打开 H5 页面，一键或通过留言，即经**企业微信**把挪车通知推给车主。

## 功能特性

- 挪车提醒 H5 页面（一键通知 / 给车主留言 / 拨打电话）
...
| `/send-message` | POST | 自定义留言，body `{"message":"...","deviceInfo":{}}`，限 500 字 | 400 / 405 / 429 / 500 |
